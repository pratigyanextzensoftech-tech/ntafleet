...
export const retailInvoice=[
 ...
 export const essoRack=[
    ...
    { value: 'Rack +3', label: 'Rack +3' },
        ...
        { value: 'Rack -6.5', label: 'Rack -6.5' },
        { value: 'Rack -7', label: 'Rack -7' },
        { value: 'Rack -7.5',label: 'Rack -7.5' },
        { value: 'Rack -8', label: 'Rack -8' },
        { value: 'Rack -8.5', label: 'Rack -8.5' },
        { value: 'Rack -9', label: 'Rack -9' },
        { value: 'Rack -9.5', label: 'Rack -9.5' },
