...
const BulkEssoForm = ({title,btnTtitle,type}) => {
  console.log(type,'++++++++++++++')
...
<HeaderCard title={title}/>
                        ...
                        <FormGroup className="m-form__group">
                            <InputGroup>
                                ...
                                <Controller name="invoice"
                                    ...
                                    defaultValue={type === "owner_operator" || type==="bulk_owner" || type==='bulk_owner_ultramar' ? [invoiceType1[3]] : null}
                                    control={control}
                                    render={({ field }) => (
                                        <Select
                                            {...field}
      options={type === "owner_operator" || type==="bulk_owner" || type==='bulk_owner_ultramar' ? [invoiceType1[3]] : invoiceType1}
 ...
 defaultValue={
          type === "bulk_ultramar"
            ...
            : { value: InVoiceSupplier[2].value, label: InVoiceSupplier[2].label }
        }
                                                control={control}
                        render={({ field }) => (
                          <Select
