...
defaultValue={
  type === "owner_operator" || type === "single_owner_ultramar"
    ? invoiceType1[3]
    : type === "repeat_ultramar"
      ...
      : null
                                    ...
                                    render={({ field }) => (
                                        <Select
                                            {...field}
      options={type === "owner_operator" || type==="single_owner_ultramar" ? [invoiceType1[3]]:   type === "repeat_ultramar"
                  ...
                  <FormGroup className="m-form__group">
                    <InputGroup >
                      ...
                      rules={{ required: "supplier is required" }}
                          defaultValue={
          type === "single_ultramar" || type==='single_owner_ultramar'
            ...
            : { value: InVoiceSupplier[2].value, label: InVoiceSupplier[2].label }
                        ...
                        render={({ field }) => (
                          <Select
                            {...field}
                                 options={
              type === "single_ultramar" || type==='single_owner_ultramar' || type==="repeat_ultramar"
