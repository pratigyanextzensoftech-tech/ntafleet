...
import {ulcompany, ul_get_rowvalue, ul_group_ulgroup as APINAME,ul_saverowvalue } from "../../../api"; 
const UpdateUltramar = ({ title, btnTitle }) => {
  ...
  { 
       ...
       const res = await fetch(ulcompany);
        ...
        { 
            ...
            axios.post(ul_saverowvalue, payload).then((res)=>{console.log(res)}).catch((err)=>{console.log(err)});
        }) 
  ...
  const onSubmit = async (formData) => {
    ...
    try {
      ...
      const rowRes = await fetch(
        `${ul_get_rowvalue}?pricing_date=${formatDate(formData.pricingDate)}`,
      );
