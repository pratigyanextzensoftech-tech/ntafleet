...
import { groupBy, optionscountry, displayFeatureCheckBoxOwner, chooseSupplierCheckBoxOwner, optionscompany, invoiceType, orderBy, fuelType, currency, InvoiceCategory, InvoiceShow, exportType, VolUnit } from '../../Forms/FormWidget/FormSelect2/OptionDatas';
import { Row, Col, Form, FormGroup, Label, Input, InputGroup, InputGroupText } from 'reactstrap';
import { Btn } from '../../../AbstractElements';
import { useForm, Controller } from 'react-hook-form';
import DatePicker from "react-datepicker";
const CreateReportOwner = ({ title }) => {
                    ...
                    <fieldset>
                        ...
                        <Form noValidate='' onSubmit={handleSubmit(onSubmit)}  >
                                ...
                                <fieldset className='inputField ' >
                                    ...
                                    <Row>
                                        {chooseSupplierCheckBoxOwner.map((item, index) => (
                                            <Col sm="3">
...
export default CreateReportOwner
