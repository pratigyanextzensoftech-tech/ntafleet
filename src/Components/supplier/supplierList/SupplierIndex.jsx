...
import {  supplier as APINAME} from '../../../api/index'
...
const SupplierIndex = () => {
  ...
  Swal.fire({
    title: 'Are you sure?',
    text: `Do you really want to delete user "${row.supplier_name}"?`,
    icon: 'warning',
    ...
    if (result.isConfirmed) {
      ...
      axios.delete(`${APINAME}/${row.id}`)
        .then((res) => {
          ...
          Swal.fire(
            'Deleted!',
            ` "${row.supplier_name}" has been deleted.`,
            'success'
          );
          ...
          <Col sm="12">
            <Card>
              ...
              <CardBody>
                  ...
                  setEdit={setEdit} btntitle="Add Supplier" btnTitle1="Reset"  onDataAdded={refreshTable}/>
              </CardBody>
            </Card>
          </Col>
        </Row>
