...
import {  transactionCheckBox, supplier, checkBoxData,  currency,InVoiceSupplier,optionscountry,Upload_Supplier,invoiceType,chooseSupplierCheckBox } from '../../Forms/FormWidget/FormSelect2/OptionDatas';
                    ...
                    <Row>
                        ...
                        <Col sm="3">
                            ...
                            <FormGroup className="m-form__group">
                                ...
                                <Controller
  name="supplier"
  defaultValue={ type==='loves'?chooseSupplierCheckBox[6]:InVoiceSupplier[1]}
  control={control}
