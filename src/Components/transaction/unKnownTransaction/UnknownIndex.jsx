...
import {  unknown_transactions as APINAME,download,transactions} from '../../../api/index'
...
const UnknownIndex = () => {
  ...
  useEffect(() => {
      ...
      GetDataTAble(from,to, state_prov,unit,card_no,currency,items,inv_status,supplier);
  }, []);

  function GetDataTAble(from,to, state_prov,unit,card_no,currency,items,inv_status,supplier) {
     const columns = [
  ...
  { data: "tax_unit_price", title: "Tax_Unit_Price" }, 
  { data: "qty", title: "Qty" }, 
  { data: "amt", title: "Amt" }, 
  { data: "tax_amt", title: "TaxAmt" }, 
...
$(document)
 ...
 console.log(formData);
    GetDataTAble(from,to ,state_prov,unit,card_no,currency,items,inv_status,supplier); // fetch new data immediately
  };
...
const handleInputChange = (e) => {
  ...
  setEdit={setEdit} onSearch={handleSearch}/>
              </CardBody>
            </Card>
          </Col>
        </Row>
