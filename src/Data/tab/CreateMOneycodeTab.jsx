...
export const CreateMoneyCodeTab = [
  {
    ...
    component: <SingleMOneyCodeForm title="Create Single MoneyCode Invoice" btnTtitle="Create  Invoice"/>,
  },
  {
    id: '2',
    label: 'Create Bulk MoneyCode Invoice',
    component: <BulkMOneyCodeForm title="Create Bulk MoneyCode Invoice" btnTtitle="Create MoneyCode Invoice"/>,
  },
