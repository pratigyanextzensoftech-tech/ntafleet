...
export const EssoBulkTab = [
  {
    ...
    component: <PricingCommon apiName={create_pricing_pdf} tax= "No" pricingDate={true} supplier={true} supplier_ids="6" testingEmail={true} validation={true} btnTitle="Create  Pricing PDF (Without Tax)" title="Create Bulk Pricing PDF (Without Tax) "/>,
  },
  {
    id: '2',
  ...
  
  {
    ...
    component: <PricingCommon tax= "Yes" apiName={create_pricing_pdf}  pricingDate={true} supplier={true} supplier_ids="6" testingEmail={true} validation={true} btnTitle="Create Pricing PDF (With Tax)" title="Create Bulk Pricing PDF (With Tax)
"/>,
  },
   {
    id: '4',
