...
export const IrvingPricingTab = [
  {
    ...
    component: <PricingCommon tableTitle="Pricing PDF List (Without Tax)"  listapi={irv_pricing_pdf}  table={true} tax= "No"  apiName={create_pricing_pdf} pricingDate={true} supplier={true} supplier_ids="5"  testingEmail={true} validation={true}  title="Create Bulk Pricing PDF" btnTitle="Create  Pricing PDF"/>,
  },
  {
    id: '2',
    label:"Mail Irving Bulk Pricing PDF (Without Tax)", 
    component: <MailPricingCommon tableTitle="Pricing PDF List (Without Tax)" supplier="IRVING" listapi={irv_pricing_pdf} tax= "No" supplier_ids="5" title="Mail Bulk Pricing PDF" btnTitle="Search pricing Pdf (Without Tax)"/>,
  },
  {
    id: '3',
...

  {
    ...
    component: <MailPricingCommon tableTitle="Pricing PDF List (With Tax)"  listapi={irv_pricing_pdf} supplier="IRV" tax= "Yes"  supplier_ids="5" title="Mail Bulk Pricing PDF (With Tax)" btnTitle="Search Pricing Pdf (With Tax)"/>,
  }
