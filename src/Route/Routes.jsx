...
export const routes = [
  ...
  { path: `${process.env.PUBLIC_URL}/check_invoice/:layout`, Component: <CheckOldINvoice /> },
    { path: `${process.env.PUBLIC_URL}/create_retail_invoice/:layout`, Component: <RetailInvoice /> },
    { path: `${process.env.PUBLIC_URL}/create_old_Invoice/:layout`, Component: <CreateOldInvoice /> },
    { path: `${process.env.PUBLIC_URL}/create_moneycode_Invoice/:layout`, Component: <CreateMoneyCode /> },
    { path: `${process.env.PUBLIC_URL}/create_esso_Invoice/:layout`, Component: <CreateEssoInvoice /> },
    { path: `${process.env.PUBLIC_URL}/manage_Macro/:layout`, Component: <ManageMacro /> },
    { path: `${process.env.PUBLIC_URL}create_customized_Invoice/:layout`, Component: <CreateCustomized /> },
    { path: `${process.env.PUBLIC_URL}create_ui_invoice/:layout`, Component: <CreateUltramar /> },
