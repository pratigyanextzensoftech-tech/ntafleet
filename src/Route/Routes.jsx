...
{ path: `/how_to_add_card`, Component: <AddCard /> },
  ...
  { path: `/check_invoice`, Component: <CheckOldINvoice /> },
    ...
    { path: `/send_bulkMail`, Component: <SendBulk /> },
    ...
    { path: `/check_Invoiced_MoneyCode`, Component: <CheckInvoicemoneyCode /> },
    { path: `/view_Reports`, Component: <ViewReports /> },
    { path: `/salesman_volume_Report`, Component: <SalesmanVol /> },
    ...
    { path: `/add_fuelCards`, Component: < AddFuel/> },
    { path: `/view_fuelCards`, Component: < ViewFuel/> },
    { path: `/fuel_cardList`, Component: < EFSFuel/> },
    ...
    { path: `/upload_t_check`, Component: < UploadTcheck/> },
    { path: `/t_checkList`, Component: < TcheckList/> },
    { path: `/create_t_check_Invoices`, Component: < CreateTCheck/> },
    { path: `view_t_check_Invoices`, Component: < ViewTCheck/> },
    ...
    { path: `/update_unit_driver`, Component: < UpdateUnit/> },
    { path: `/view_efs_transaction`, Component: < ViewEfs/> },
    { path: `/rackTo_retail_transaction`, Component: < RackToRetail/> },
    { path: `/retailTo_rack_transaction`, Component: < RetailToRack/> },
